...
export const NAV_ITEMS = [
  ...
  { label: 'History', screen: 'history', icon: ['M12 8v4l3 3M12 2a10 10 0 100 20 10 10 0 000-20z'] },
      ...
      {showLogoutConfirm && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 8px', fontSize: '17px', fontWeight: '700', color: '#1e293b' }}>Confirm Logout</h3>
            <p style={{ margin: '0 0 24px', fontSize: '13.5px', color: '#64748b', lineHeight: '1.5' }}>Are you sure you want to logout from AnesGuard?</p>
